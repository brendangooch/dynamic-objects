...
function testAll(): void {
    describe('DynamicPosition', () => {
        ...
        // CAN COPY ALL TESTS FROM BEZIER AND REPLACE DYNAMIC BEZIER WITH DYNAMIC POSITION
        ...
        // public setControlPoint(distance: number, angle: number): DynamicPosition
        // control point can only be set if not active
        // when duration is set and control point IS set resulting path is curved
        // when duration is set and control point is NOT set resulting path is curved
        ...
        // returns expected current values during full duration and control point set
        // returns expected current values during full duration when speed is set and control point set
        // returns expected current values during full duration with ease applied and control point set
